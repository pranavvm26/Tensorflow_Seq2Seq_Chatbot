...
def get_id2line():
    lines=open(os.getcwd()+'/data/movie_lines.txt', encoding='utf-8', errors='ignore')
    lines = lines.read()
    lines = lines.split('\n')
    id2line = {}
    for line in lines:
...
def get_conversations():
    conv_lines = open(os.getcwd()+'/data/movie_conversations.txt',encoding='utf-8', errors='ignore').read().split('\n')
    convs = []
...
prepare_seq2seq_files(questions,answers, path=os.getcwd()+'/data/')
